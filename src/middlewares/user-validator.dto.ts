...
import DtoSchemas from '../lib/dto-Schemas';


/* class UserValidatorDto {
    private ajv: Ajv;
    private dtoSchema: TObject<{}>;
    private validateSchema: ValidateFunction;

    constructor(fields: TProperties) {
        ...
        this.dtoSchema = this.createDTOSchema(fields);
        this.validateSchema = this.ajv.compile(this.dtoSchema);
  console.log('hola contructor');
    }
...
const userValidDtoRegister = new UserValidatorDto(DtoSchemas.userRegisterSchema);
userValidDtoRegister.createDTOSchema(DtoSchemas.userRegisterSchema);

const userValidatorRegister = userValidDtoRegister.validateDTO.bind(userValidDtoRegister);

//validador para el login de usuarios
const userValidDtoLogin = new UserValidatorDto(DtoSchemas.userLoginSchema);
const userValidatorLogin =userValidDtoLogin.validateDTO.bind(userValidDtoLogin);

//Exportaciones de cada uno de los validadores
export { userValidatorRegister, userValidatorLogin }; */
